...
public class VariableMain {
	...
	public static void main(String[] args) {
		...
		// 해당커서 주석처리
		// 단축키[Ctrl+/]
//		System.out.prrintln(myMoney);

		// 변수의 값 할당
		// 변수 초기화(Initalization = init) 라고 한다
...
//		MATH_PI = 4.23;
		...
		// .charAt(인덱스)
		// index는 배열, 문자열에서 몇 번째에 해당하는 숫자
		// index는 0부터 시작 ( 첫번째는 = index 0)
...
//		해당 문자열을 시작 인덱스부터 끝 인덱스 전까지 자른다.
		...
		// .trim()
		// 해당 문자열의 양끝에 존재하는 모든 공백 문자를 제거해준다.
		String world = " The World is Destroyed         ";
		...
		System.out.println(empty.concat("채웠을"));
//		

		// 문자 (char)
		// 작은따옴표('') 안에 한 문자를 담을 수 있으며
		// 숫자 또한 다음 수 있다.
		...
		// int 곱하기 double은 double 타입으로 자동 형변화를 한다.
		double mulResult = intVal + doubVal;

		// int 곱하기 float을 해도 float 타입으로 자동 형변환 된다.
		float floalRst = intVal * 1.23f;

		// int 20000이 long 타입으로 자동 형변환되어ㅏ 담긴것
		long longVal = 20000;
		...
		//.강제 형변환
		// (타입) 값
		// 형변환이 가능한 경우 대해, 해당 값이 괄호 안 타입으로 변환된다.
